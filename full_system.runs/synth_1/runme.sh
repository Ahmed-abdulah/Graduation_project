...
HD_PWD='C:/Users/lenovo/Downloads/FULL_SYSTEM/full_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log batchnorm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source batchnorm.tcl
