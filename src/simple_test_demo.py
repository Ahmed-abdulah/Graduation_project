#!/usr/bin/env python3
"""
Simple Test Demo - Test different disease patterns
"""
...
def test_disease_pattern(disease_name):
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print("WARNING: Simulation failed or ModelSim not available")
            print("Using existing analysis capabilities")
    except:
        print("WARNING: ModelSim not available, using existing results")
...
def main():
    """Main function"""
    print("Simple Disease Testing Demo")
    print("=" * 40)
    print()
